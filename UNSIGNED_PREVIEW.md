...
「このまま開く」は、最初に起動を試してから約1時間表示されます。詳しくは[Apple公式の案内](https://support.apple.com/guide/mac-help/mh40617/mac)を参照してください。新しいビルドで再びブロックされた場合は、同じ「このまま開く」手順を実行してください。将来Developer IDで署名・公証した正式版では、この操作は不要になります。
